...
import {
  DEFAULT_SITE_LOGO,
  DEFAULT_SITE_NAME,
  resolveBrandSiteLogo,
  resolveBrandSiteName,
  resolveBrandSiteSubtitle,
} from '@/config/brand'
...
export const useAppStore = defineStore('app', () => {
  ...
  function applySettings(config: PublicSettings): void {
    const normalizedConfig = {
      ...config,
      site_name: resolveBrandSiteName(config.site_name),
      site_logo: resolveBrandSiteLogo(config.site_logo),
      site_subtitle: resolveBrandSiteSubtitle(config.site_subtitle),
    }
